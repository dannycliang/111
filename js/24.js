(function() {
  var dat = [ { label: 'Remove it from the game completely', b: 165 },
            { label: "Reduce its frequency, but leave it in the game", b: 431 },
            { label: "Make no change", b: 561 }
            ];

var svg = d3.select('.Results24')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
