(function() {
  var dat = [ { label: 'Big markets have far too much power', b: 376 },
            { label: "Big markets have a little too much power", b: 473 },
            { label: "It's balanced", b: 272 },
            { label: "Small markets have a little too much power", b: 25 },
            { label: "Small markets have far too much power", b: 9 }
            ];

var svg = d3.select('.Results18')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
