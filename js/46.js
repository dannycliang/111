(function() {
  var dat = [ { label: 'Outside the United States', b: 174 },
            { label: "Northeastern US", b: 211 },
            { label: "Southern US", b: 213 },
            { label: "Midwestern US", b: 284 },
            { label: "West Coast US", b: 233 },
            { label: "Other part of US", b: 43 }
            ];

var svg = d3.select('.Results46')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
