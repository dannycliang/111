(function() {
  var dat = [ { label: 'Yes, and the NBA is alone as my favorite sports league', b: 498 },
            { label: "Yes, but I care about other league(s) as much", b: 330 },
            { label: "No, but it is among my most followed leagues", b: 303 },
            { label: "No, and it is not among my most followed leagues", b: 27 }
            ];

var svg = d3.select('.Results4')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
