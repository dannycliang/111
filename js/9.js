(function() {
  var dat = [ { label: 'Always supportive', b: 75 },
            { label: "Generally supportive, with exceptions", b: 220 },
            { label: "Neutral", b: 299 },
            { label: "Generally against, with exceptions", b: 432 },
            { label: "Always against", b: 132 }
            ];

var svg = d3.select('.Results9')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
