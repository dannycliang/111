(function() {
  var dat = [ { label: '1995-96 Chicago Bulls', b: 440 },
            { label: "2015-16 Golden State Warriors", b: 26 },
            { label: "2016-17 Golden State Warriors", b: 502 },
            { label: "1985-86 Boston Celtics", b: 48 },
            { label: "1999-00 Los Angeles Lakers", b: 51 },
            { label: "Another team", b: 91 }
            ];

var svg = d3.select('.Results29')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
