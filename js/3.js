(function() {
  var dat = [ { label: 'Advanced Stats should be used almost exclusively', b: 19 },
            { label: "Advanced Stats and the Eye test should both be used, with more emphasis on Advanced Stats", b: 370 },
            { label: "Advanced Stats and the Eye test should both be used, weighed equally", b: 553 },
            { label: "Advanced Stats and the Eye test should both be used, with more emphasis on the Eye Test", b: 201 },
            { label: "The Eye Test should be used almost exclusively", b: 15 }
            ];

var svg = d3.select('.Results3')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
