(function() {
  var dat = [ { label: 'Completely eliminate both', b: 380 },
            { label: "Eliminate the screen fouls, but keep the jumping into the defender foul to some degree", b: 164 },
            { label: "Eliminate the jumping into the defender foul, but keep the screen foul to some degree", b: 118 },
            { label: "Reduce the occurrences of both, but keep some room for them", b: 414 },
            { label: "Make no change", b: 82 }
            ];

var svg = d3.select('.Results13')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
