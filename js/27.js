(function() {
  var dat = [ { label: 'More successful than current players', b: 88 },
            { label: "Equally successful", b: 602 },
            { label: "Less successful than current player", b: 468 }
            ];

var svg = d3.select('.Results27')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
