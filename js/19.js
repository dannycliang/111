(function() {
  var dat = [ { label: 'The max contract should be removed entirely', b: 254 },
            { label: "The max contract should be kept but be reworked", b: 429 },
            { label: "There should be some other change to max contracts", b: 137 },
            { label: "Max contracts are fine as is", b: 334 }
            ];

var svg = d3.select('.Results19')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
