(function() {
  var dat = [ { label: 'Reduce the number of regular season games', b: 315 },
            { label: "Increase the length of the season", b: 281 },
            { label: "Keep the length of the season and number of games the same, but adjust the scheduling formula", b: 415 },
            { label: "Make no change", b: 147 },
            ];

var svg = d3.select('.Results12')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
