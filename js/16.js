(function() {
  var dat = [ { label: 'It should go even further in this direction', b: 98 },
            { label: "It's good as is now", b: 717 },
            { label: "It's gone too far in this direction", b: 343 }
            ];

var svg = d3.select('.Results16')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
