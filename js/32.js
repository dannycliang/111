(function() {
  var dat = [ { label: 'He should be criticized both as a man and as a player', b: 236 },
            { label: "He should not be criticized as a player, but he should be criticized as a man", b: 279 },
            { label: "He should not be criticized as a man, but he should be criticized as a player", b: 308 },
            { label: "He should not be criticized at all", b: 335 }
            ];

var svg = d3.select('.Results32')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
