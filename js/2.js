(function() {
  var dat = [ { label: 'I would always want my team to tank if it seems advantageous', b: 311 },
            { label: "I'm ok with my team tanking for a period, but not as a long-term strategy", b: 511 },
            { label: "I'm ok with my team tanking a few games at the end of each year, but not any more than that", b: 167 },
            { label: "I would never want my team to tank, regardless of the circumstances", b: 169 }
            ];

var svg = d3.select('.Results2')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
