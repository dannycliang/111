(function() {
  var dat = [ { label: 'Seed the playoffs 1-16, ignoring conferences', b: 561 },
            { label: "Realign the conferences by moving teams from conference to conference", b: 101 },
            { label: "Make some other change", b: 193 },
            { label: "Make no change", b: 303 },
            ];

var svg = d3.select('.Results11')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
