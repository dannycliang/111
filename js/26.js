(function() {
  var dat = [ { label: 'Cavaliers win in 7', b: 381 },
            { label: "Warriors win in 5", b: 353 },
            { label: "Warriors win in 6", b: 331 },
            { label: "Warriors win in 7", b: 93 }
            ];

var svg = d3.select('.Results26')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
