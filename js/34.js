(function() {
  var dat = [ { label: 'Harden by a significant margin', b: 88 },
            { label: "Harden by a narrow margin", b: 254 },
            { label: "Neutral", b: 129 },
            { label: "Westbrook by a narrow margin", b: 434 },
            { label: "Westbrook by a significant margin", b: 253 }
            ];

var svg = d3.select('.Results34')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
