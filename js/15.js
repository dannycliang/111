(function() {
  var dat = [ { label: 'Far too lenient', b: 440 },
            { label: "A little too lenient", b: 508 },
            { label: "Just right", b: 187 },
            { label: "A little too harsh", b: 18 },
            { label: "Far too harsh", b: 5 }
            ];

var svg = d3.select('.Results15')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
