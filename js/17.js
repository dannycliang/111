(function() {
  var dat = [ { label: 'Players should allowed to enter the draft after high school', b: 636 },
            { label: "Players should have to spend longer after high school before entering the draft", b: 151 },
            { label: "It should be changed in some other way", b: 145 },
            { label: "It's fine as is", b: 223 }
            ];

var svg = d3.select('.Results17')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
