(function() {
  var dat = [ { label: 'It should be a major factor', b: 132},
            { label: "It should be a factor", b: 627 },
            { label: "It should be a minor factor", b: 322 },
            { label: "It should not be a factor", b: 77 }
            ];

var svg = d3.select('.Results7')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
