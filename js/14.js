(function() {
  var dat = [ { label: 'Strongly against any ads', b: 416 },
            { label: "Against ads any more prominent than the current ones", b: 341 },
            { label: "Indifferent to ads", b: 355 },
            { label: "Supportive of even more ads on jerseys", b: 46 }
            ];

var svg = d3.select('.Results14')
              .append('svg')
              .attr('width', 1100)
              .attr('height', 300)
              .append('g')
